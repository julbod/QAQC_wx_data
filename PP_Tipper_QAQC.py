...
for l in range(len(wx_stations_name)):       
    ...
    # otherwise, if data (most stations), keep running
        ...
        qaqced_array = pd.concat([qaqc_arr_final['DateTime'],qaqc_arr_final['PP_Tipper'],qaqc_arr_final['PP_Tipper_flags']],axis=1)
        ...
        existing_qaqc_sql[colnames[col_positions]] = pd.concat([qaqced_array['PP_Tipper'],qaqced_array['PP_Tipper_flags']],axis=1)
