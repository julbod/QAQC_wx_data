...
for l in range(len(wx_stations_name)): 
    ...
    Path("D:/Vancouver_Island_University/Wx_station/wx_data_processing/QAQC/v2/individual_figures/" + sql_database + "/Pk_Wind_Speed").mkdir(parents=True, exist_ok=True)
    os.chdir("D:/Vancouver_Island_University/Wx_station/wx_data_processing/QAQC/v2/individual_figures/" + sql_database + "/Pk_Wind_Speed")
    ...
    var = 'Pk_Wind_Speed'
    var_name = 'Peak Wind Speed'
    var_name_short = 'Pk_Wind_Speed'
    ...
    for k in range(len(yr_range)):
        ...
        qaqc_arr['Pk_Wind_Speed_flags'] = flags.apply(qaqc_functions.merge_row, axis=1)
    ...
    # otherwise, if data (most stations), keep running
        ...
        qaqced_array = pd.concat([qaqc_arr_final['DateTime'],qaqc_arr_final['Pk_Wind_Speed'],qaqc_arr_final['Pk_Wind_Speed_flags']],axis=1)
        ...
        existing_qaqc_sql[colnames[col_positions]] = pd.concat([qaqced_array['Pk_Wind_Speed'],qaqced_array['Pk_Wind_Speed_flags']],axis=1)
