...
for l in range(len(wx_stations_name)):  
    ...
    # otherwise, if data (most stations), keep running
        ...
        qaqced_array = pd.concat([qaqc_arr_final['DateTime'],qaqc_arr_final['Wind_Dir'],qaqc_arr_final['Wind_Dir_flags']],axis=1)
        ...
        existing_qaqc_sql[colnames[col_positions]] = pd.concat([qaqced_array['Wind_Dir'],qaqced_array['Wind_Dir_flags']],axis=1)
